...
// 1. function: generate random numbers that match button and push to new array
// e.g. generate 24 random numbers (attach to onClick function)
// 2. new function: 
...
let makeShort = () => {
	for (let i = 0; i < 24; i = i + 1) {
		...
		// add that word to new array called newRandomArray
		newRandomArray.push(randomWord);
		console.log('new random array', newRandomArray);
		newRandomArray.map(function	(i) {
